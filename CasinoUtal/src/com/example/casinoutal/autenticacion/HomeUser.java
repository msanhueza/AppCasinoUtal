...
/**
 * Actividad encargada de la lógica de las opciones del menú principal para un usuario
 * crear menú, ver menú, encuesta, estadisticas, cambiar contraseña, cerrar sesión
 */
public class HomeUser extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		verMenu.setOnClickListener(new OnClickListener() { //listener para el evento ver menú
			@Override
		...
		cerrarSesion.setOnClickListener(new OnClickListener() { //listener para el evento cerrar sesión
			...
			public void onClick(View arg0) {
				...
				db.close();
				Intent intent = new Intent(HomeUser.this, Autenticacion.class); // se envia a la activity de iniciar sesión
